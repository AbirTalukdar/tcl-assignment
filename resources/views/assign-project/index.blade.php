...
@section('title'){{ 'Assign Project' }}@endsection
@section('header.css')
    <style>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="text-end mb-3">
                                <a href="{{ route('assign.create') }}" class="btn btn-md btn-info " ><i class="fa fa-plus"></i>Create New</a>
                            </div>
                            <div class="table-responsive">
                                <table id="assignTable" class="table table-striped"></table>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            $('#assignTable').DataTable({
                ...
                columns: [
                    ...
                    {title: 'Action', className: "text-center", data: function (data) {
                            return '<a title="edit" class="btn btn-warning btn-sm" data-panel-id="' + data.id  + '" onclick="editAssignProject(this)"><i class="fa fa-edit"></i></a>'+
                                ' <a title="delete" class="btn btn-danger btn-sm" data-panel-id="' + data.id + '" onclick="deleteAssignProject(this)"><i class="fa fa-trash"></i></a>';
        ...
        function deleteAssignProject(x) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $('#assignTable').DataTable().clear().draw();
                },
            });
        }
    </script>
