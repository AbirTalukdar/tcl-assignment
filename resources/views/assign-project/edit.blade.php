...
@section('title'){{ 'Assign Project Edit' }}@endsection
@section('header.css')
    <style>
                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Assign Project Edit</li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                            <form class="form-wizard" action="{{ route('assign.update', $assignedProject->id ) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="row ">
                                    <div class="col-md-8">
                                        <div class="mb-3">
